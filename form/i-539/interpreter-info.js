const formKey = "i539-6";
const validPrefix = "i539Valid-";
const validKey = `${validPrefix}6`;
...
function toggleConditionalSections() {
   fields.forEach(field => {
      if (field.type !== "signature") {
         ...
         document.getElementById(field.id).required = !!required;
      }
   });
}
...
const canvas = document.getElementById('signatureInterpreter');
