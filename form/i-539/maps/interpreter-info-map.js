...
// Keep the I-485 validation rules and add I-539 storage/PDF metadata.
const fields = [
   ...contactFields.map(field => ({
      ...field,
      pdfField: field.id,
      type: field.id === "interpreter_email" ? "email" : "text",
      required: field.condition || false
   })),
   { id: "signatureInterpreter", type: "signature", required: false, validate: () => true, message: "" }
];
